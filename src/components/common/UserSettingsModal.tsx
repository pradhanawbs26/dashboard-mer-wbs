...
export const UserSettingsModal: React.FC<UserSettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 overflow-y-auto p-3 sm:p-4 flex items-center justify-center">
          ...
          <div className="flex items-center space-x-2 min-w-0">
            ...
            <div className="min-w-0">
              <h3 className="font-extrabold text-sm sm:text-base text-slate-900 truncate">
                Pengaturan Akun ({currentUser.role === 'group_leader' ? 'Group Leader' : currentUser.role === 'head_coach' ? 'Head Coach' : currentUser.role === 'subordinate' ? 'Subordinat' : 'Admin'})
              </h3>
